...
<div class="container allContent">
    ...
    <div style="height: 500px">
        ...
        <div class="row" style="margin-bottom: 20px;">
            ...
            <c:if test="${pageModel.courses.size()==0}">
                <p style="font-size: 30px">未找到符合搜索条件的课程 :)</p>
            </c:if>
        </div>
    </div>
    ...
    <div>
        ...
        <ul class="pager" style="margin-top: 40px;">
            ...
            <c:if test="${pageModel.currentPage > 0}">
                <li class="previous"><a
                        href="${pageContext.request.contextPath}/course/search/${pageModel.string}/${pageModel.currentPage-1}">&larr;上一页</a>
                </li>
            </c:if>
            ...
            <c:if test="${pageModel.currentPage < pageModel.pages -1}">
                <li class="next"><a
                        href="${pageContext.request.contextPath}/course/search/${pageModel.string}/${pageModel.currentPage+1}">下一页&rarr;</a>
                </li>
            </c:if>
        </ul>
    </div>
